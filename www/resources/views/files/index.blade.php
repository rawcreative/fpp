        ...
        <div class="panel">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane file-tab active" id="sequenceTab">
                        ...
                        <div class="info"><p>Sequence files must be in the Falcon Pi Player .fseq format and may be converted from various other sequencer formats using xLights or Light-Elf. The Vixen 3 sequencer has the ability to directly export .fseq files.</p></div>
                    </div>
    ...
    <section class="upload">
        <div class="panel">
            ...
            <div class="panel-body">
             <form action="/files" class="dropzone"></form>
            </div>
        </div>
    </section>
