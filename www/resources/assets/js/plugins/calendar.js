(function($) {
    ...
    $.fn.fppcalendar = function(method) {
        var methods = {

                init: function(options) {
                    this.fppcalendar.settings = $.extend({}, this.fppcalendar.defaults, options);
            ...
            //Private Vars
        var settings = $.fn.fppcalendar.settings;
        var content;
        var daysOfMonth;
        var setActive;
        ...
        var cellHeight;
        var startOfWeekDate;
        var calendar = $.fn.fppcalendar.defaults.calendar;
        var helpers = {
            /**
             * Main Init function
             */
            checkOptionsAndBuild: function() {
                ...
                if (settings.now != null) {
                    calendar.month = moment($.fn.fppcalendar.settings.now).month();
                    calendar.year = moment($.fn.fppcalendar.settings.now).year();
                    calendar.date = moment($.fn.fppcalendar.settings.now).format("D");
                    calendar.dayOfWeek = moment($.fn.fppcalendar.settings.now).day();
                    calendar.monthLong = moment($.fn.fppcalendar.settings.now).format('MMM');
                } else {
                ...
                $.fn.fppcalendar.settings.onViewRenderComplete.call(this);
            ...
            drawEvent: function(eventStartHours, eventStartMins, eventEndHours, evenEndMins, cellNo, arrayIndex, eventDuration) {
                ...
                $.fn.fppcalendar.settings.onEventRender.call(this);
            },
                ...
                $(".event-container")
                    .resizable({
                        ...
                        stop: function(event, ui) {
                            ...
                            $.fn.fppcalendar.settings.onEventResizeComplete(eventO);
                        }
                    });
                $('.cell-inner').sortable({
                    ...
                    receive: function(event, ui) {
                        ...
                        var eventO = helpers.constructEventForUser(i);
                        helpers.setEventBubbles(settings.events);
                        $.fn.fppcalendar.settings.onEventDragComplete(eventO);
                    }
                });
            },
            ...
            timeSlotDblClick: function(obj) {
                ...
                $.fn.fppcalendar.settings.onTimeSlotDblClick(timeSlot);
            },
            ...
            bindEventHanders: function() {
                ...
                $('.event-container').live('click', function() {
                    ...
                    $.fn.fppcalendar.settings.onEventClick(eventO);
                });
        ...
        if (methods[method]) {
            ...
            $.error('Method "' + method + '" does not exist in fppcalendar plugin!');
        }

    }

    $.fn.fppcalendar.defaults = {
        ui: {
            year: {
                visible: true,
                format: 'YYYY',
    ...
    $.fn.fppcalendar.defaults.calendar = {
        year: moment().year(),
