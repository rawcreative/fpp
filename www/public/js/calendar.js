    ...
    $(document).ready(function() {
        ...
        $('body').fppcalendar({
            ...
            onTimeSlotDblClick: function(timeSlot) {
                ...
                $('body').fppcalendar('addEvent', newEvent);
        ...
        $('body').fppcalendar('render');

        // Some Other Public Methods That can be Use are below \
        //console.log($('body').fppcalendar('getEvents'))
        //get the value of a property
        //console.log($('body').fppcalendar('getDate','MMMM'));
        ...
        $('#eventSave').on('click', function() {
            ...
            $('body').fppcalendar('updateEvent', $('#eventIndex').val(), selectedEvent);

            $('#calendar-event').removeClass('open');
        });
        $('#eventDelete').on('click', function() {
            $('body').fppcalendar('removeEvent', $('#eventIndex').val());
            selectedEvent.other.code = $('#txtEventCode').val();
            selectedEvent.other.location = $('#txtEventLocation').val();

            $('#element').fppcalendar('updateEvent', $('#eventIndex').val(), selectedEvent);
            $('#calendar-event').removeClass('open');

        });
        $('#eventDelete').on('click', function() {
            $('#element').fppcalendar('removeEvent', $('#eventIndex').val());
            $('#calendar-event').removeClass('open');
        });
    });
